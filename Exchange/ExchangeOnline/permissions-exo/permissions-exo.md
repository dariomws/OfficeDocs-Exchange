...
|Company Administrator (**TenantAdmins\_**_\<unique value\>_)|The Company Administrator role group doesn't have any roles assigned to it. However, it's a member of the Organization Management role group and inherits the permissions provided by that role group. <br/> This role group can't be managed in Exchange Online. You can add members to this role group by adding users to the Global admin Office 365 role|
...
|Exchange Service Administrator (**ExchangeServiceAdmins\_**_\<unique value\>_)|The Exchange Service Administrator role group doesn't have any roles assigned to it. However, it's a member of the Organization Management role group and inherits the permissions provided by that role group. <br/> This role group can't be managed in Exchange Online. You can add members to this role group by adding users to the Exchange admin Office 365 role.|
...
|Helpdesk Administrator (**HelpdeskAdmins\_**_\<unique value\>_)|The Helpdesk Administrator role group doesn't have any roles assigned to it. However, it's a member of the View-Only Organization Management role group and inherits the permissions provided by that role group. <br/> This role group can't be managed in Exchange Online. You can add members to this role group by adding users to the Helpdesk admin Office 365 role.|
|Hygiene Management|Administrators who are members of the Hygiene Management role group can manage Exchange anti-spam features and grant permissions for antivirus products to integrate with Exchange.|
...
|Security Administrator|Administrators who are members of the Security Administrator role group can view and edit configuration and reports for Security features. Also, they can create, edit, delete, and view usage of sensitivity labels and their policies.|
|Security Reader|Administrators who are members of the Security Reader role group can view configuration and reports for Security features.|
|Security Administrator (**SecurityAdmins\_**_\<unique value\>_)|The Security Administrator role group doesn't have any roles assigned to it. However, it's a member of the Security Administrator role group and inherits the permissions provided by that role group. <br/> This role group can't be managed in Exchange Online. You can add members to this role group by adding users to the Security admin Office 365 role.|
|UM Management|Administrators who are members of the UM Management role group can manage Unified Messaging organization, server, and recipient configuration. <br/> Adding members to this role group has no impact as Unified Messaging (UM) in Exchange Online has been retired and replaced with Cloud Voicemail and Auto Attendant services.|
